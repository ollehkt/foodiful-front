...
const MetaHead = ({ title, description, url, img }: PropsType) => {
  return (
    <Head>
      ...
      <meta property="og:image" content={img || 'https://www.foodiful.shop/public/foodiful.jpeg'} />
      ...
      <meta name="twitter:image" content="https://www.foodiful.shop/public/foodiful.jpeg" />
    </Head>
  )
}
